...
import in.koyad.piston.app.siteexplorer.actions.ListFramesPluginAction;
import in.koyad.piston.common.utils.LogUtil;
import in.koyad.piston.controller.plugin.Plugin;
import in.koyad.piston.controller.plugin.annotations.AnnoPlugin;

@AnnoPlugin(name = "frameManager", title = "Frame Manager", defaultAction = ListFramesPluginAction.ACTION_NAME)
public class FrameManagerPlugin extends Plugin {

	private static final LogUtil LOGGER = LogUtil
			.getLogger(FrameManagerPlugin.class);
